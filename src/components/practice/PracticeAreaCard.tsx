  ...
  return (
    ...
    >
      <article className="flex h-full flex-col">
        ...
        <span className="mx-auto mt-auto inline-flex translate-y-3 items-center justify-center px-0 pb-3 pt-4 text-base font-semibold text-[#111B36] transition-colors group-hover:text-[#C8A96A]">
          <span>자세히 보기</span>
          <span
            aria-hidden="true"
            className="ml-3 text-[#C8A96A] transition-transform group-hover:translate-x-1.5"
          >
            →
          </span>
        </span>
