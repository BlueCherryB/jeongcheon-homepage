    ...
    <section className="bg-[#FAF8F4]">
      <Container className="py-18 sm:py-24 lg:py-28">
        <article className="mx-auto max-w-[800px]">
          ...
          <div className="mt-10 space-y-6 break-keep text-left text-[16px] leading-8 text-[#111B36]/78 sm:mt-12 sm:text-[17px] sm:text-justify sm:leading-9">
          ...
          <div className="mt-14 space-y-14 sm:mt-16 sm:space-y-16">
            {introduction.sections.map((section) => (
              <section key={section.title}>
                ...
                <div className="mt-6 space-y-6 break-keep text-left text-[16px] leading-8 text-[#111B36]/78 sm:text-[17px] sm:text-justify sm:leading-9">
